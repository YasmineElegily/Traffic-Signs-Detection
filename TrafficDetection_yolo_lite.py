...
# pip install tensorflow==2.3.0-rc0
...
weights = r"F:\Education\Level 400 Second and FINAL TERMMM\Project 3 (Final Project)\Traffic Signs Recognition\tensorflow-yolov4-tflite-master\checkpoints\custom-416.tflite"
# weights = "Resources\\yolov4-416-fp1601.tflite"
# weights="Resources\\yasmin-416.tflite"
# score=0.25
score = 0.5
iou=0.45
    ...
    for i in range(num_boxes[0]):
        ...
        if class_name not in allowed_classes:
            ...
            if show_label:
                ...
                cv2.putText(image, bbox_mess, (c1[0], int(c1[1] - 2)), cv2.FONT_HERSHEY_SIMPLEX, fontScale, (0, 0, 0), bbox_thick // 2, lineType=cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    cap = cv2.VideoCapture('signs2.mp4')
    cap.set(3, 640)
    cap.set(4, 480)
    prev_frame_time = 0
    new_frame_time = 0
